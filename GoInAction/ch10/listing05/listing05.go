...
// bike repesents a concrete type for the example.
type bike struct{}

// Move can change the postion of a bike.
func (bike) Move() {
...
func main() {
	...
	// Declare virables of the MoverLocker and Mover interfaces set to their
	// zero value.
	var ml MoveLocker
	var m Mover
	...
	// prog.go:65: cannot use m (type Mover) as tyep MoveLocker in assignment:
	...
	// It is irrelevent that  the concrete type value of type bike that is stored
