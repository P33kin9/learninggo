...
// Differs sligtly from the book to show more.
package listing12
...
<rss>
<channel>
	<title> Going Programming</title>
	<description>Go : https://github.com/goinggo</description>
...
// TestDownloading validates the http Get function can download content
...
// Item defines the fields assciated with the item tag in
...
// Channel defines the fields assciated with the channel tag in
// the bouy RSS document.
type Channel struct {
